...
def test_context_passing_detailed():
    ...
    assert context_received['pre_save'] is not None, "pre_save context should not be None"
    assert context_received['post_save'] is not None, "post_save context should not be None"

    # Verify context content
    assert 'is_creation' in context_received['pre_save'], "Context should contain 'is_creation'"
    assert context_received['pre_save']['is_creation'] is True, "is_creation should be True for new objects"

    assert 'is_creation' in context_received['post_save'], "Context should contain 'is_creation'"
    assert context_received['post_save']['is_creation'] is True, "is_creation should be True for new objects"
    ...
    assert context_received['pre_save']['is_creation'] is False, "is_creation should be False for updates"
    assert context_received['post_save']['is_creation'] is False, "is_creation should be False for updates"
